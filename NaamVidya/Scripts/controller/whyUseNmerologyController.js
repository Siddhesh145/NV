var whyUseNmerologyController = function ($scope, $location, ngMeta) {
    console.log('why Use Nmerology  Controller called');
...
whyUseNmerologyController.$inject = ['$scope', '$location', 'ngMeta'];