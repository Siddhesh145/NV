var NumNumerologyMainController = function ($scope, $location, ngMeta) {
    console.log('NumNumerologyMain Controller called')
    //alert("Blog Controller Called");

    ngMeta.setTitle('Numerology number', ' | New Born Baby Name');
...
NumNumerologyMainController.$inject = ['$scope', '$location', 'ngMeta'];