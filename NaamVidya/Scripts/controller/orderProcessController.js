var orderProcessController = function ($scope, $location, commonService, globals, ngMeta) {

    console.log('Order Process controller called');

    ngMeta.setTitle('Order Process', ' | Naamvidya');
...
orderProcessController.$inject = ['$scope', '$location', 'commonService', 'globals', 'ngMeta'];