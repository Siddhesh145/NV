var mynameController = function ($scope, $location, $stateParams, commonService, globals, ngMeta) {
    ...
    $scope.getPartial = function () {
        ...
        if (sessionStorage.getItem('datafornameanalysis') != 'ERROR') {
            filename = "NameReport/" + sessionStorage.getItem('datafornameanalysis');
        }
        // if (globals.fileName != 'ERROR') {
        // filename = "Files/" + globals.fileName;
        // }
        return filename;
    };
    ...
    //});
    //off();
    //$location.path('myname/Siddhesh').replace();
}
mynameController.$inject = ['$scope', '$location', '$stateParams', 'commonService', 'globals', 'ngMeta'];